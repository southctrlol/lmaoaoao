...
//error logs//
const errorChannel = ''; //replace with your err channel id
...
//server joined//
client.on('guildCreate', async (guild) => {
    const channel = await client.channels.cache.get(''); //replace with your server join channel id
...
///guild leave//
client.on('guildDelete', async (guild) => {
    const channel = await client.channels.cache.get(''); //replace with your server  leve logs channel id
    const name = guild.name;
    const memberCount = guild.memberCount;
    const owner = guild.ownerId;
...
client.on(Events.InteractionCreate, async (interaction) => {
    ...
    const channel = await client.channels.cache.get(''); //replace with your server commands logs channel id
